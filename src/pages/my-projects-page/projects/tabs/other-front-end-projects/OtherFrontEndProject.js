  ...
  return (
    ...
    >
      <ProjectPage>
        <ProjectCard>
          <CardActionArea
            href="https://portfoliowebsitewg.netlify.app/#/"
            target="_blank"
          ...
          >
            ...
            <CardContent>
              <TitleSection>
                ...
                <GLink
                  href="https://github.com/NeoHuncho/Porfolio-Website"
                  target="_blank"
                >
                  <Github src={github} />
                </GLink>
        ...
        <ProjectCard>
          <CardActionArea
            href="https://expensetracker-reactproject.netlify.app/"
            target="_blank"
            style={{ textDecoration: "none" }}
          >
            <CardMedia
            ...
            <CardContent>
              <TitleSection>
                ...
                <GLink
                  href="https://github.com/NeoHuncho/expense-tracker"
                  target="_blank"
                >
                  <Github src={github} />
                </GLink>
        ...
        <ProjectCard>
          <CardActionArea
            href="https://awesome-bohr-10de14.netlify.app/"
            target="_blank"
            style={{ textDecoration: "none" }}
          >
            <CardMedia
            ...
            <CardContent>
              <TitleSection>
                ...
                <GLink
                  href="https://github.com/NeoHuncho/To-do-list-react/blob/master/package.json"
                  target="_blank"
                >
                  <Github src={github} />
                </GLink>
