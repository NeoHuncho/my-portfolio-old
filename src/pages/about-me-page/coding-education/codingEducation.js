...
import { FullPage, Title, TitleSection,ImageSection} from '../../../styling/styles'
...
export default function CodingEducation() {
    ...
    return (
        ...
        <ThisPage style={{ zIndex: 1 }}>
            ...
            <InnerGrid>
            <ThisImageSection ref={ref} style={{ zIndex: 0 }} initial={{ opacity: 0 }}  transition={{ ease: "easeOut", duration: 1.25 }}animate={{ opacity:inView?1:0 }}>
